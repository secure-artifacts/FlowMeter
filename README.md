...
FlowMeter 适用于 **Windows 10 或 Windows 11 64 位**。电脑需要预先安装并运行 **VoiceMeeter Banana 或 VoiceMeeter Potato**；FlowMeter 本身为免安装 ZIP，不安装或替代 VoiceMeeter。通道 3 仅在 Potato 模式可用。
